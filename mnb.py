...
def preprocess(sentence):
    ...
    for line in sentence:
        ...
        stemmed_line = stemming_words(legal_line)
        processed_sentence.append(stemmed_line)
...
count = CountVectorizer(token_pattern='[a-zA-Z0-9#@_$%]{2,}', max_features=2000, lowercase=True)
